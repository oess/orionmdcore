...
project = 'orionmdcore'
copyright = '2021, OpenEye'
author = 'OpenEye'

import orionmdcore
# The short X.Y version
version = orionmdcore.__version__
...
htmlhelp_basename = 'orionmdcoredoc'
...
latex_documents = [
    (master_doc, 'orionmdcore.tex', 'MDOrion Documentation',
     'OpenEye', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'orionmdcore', 'OrionMDCore Documentation',
     author, 'orionmdcore', 'One line description of project.',
     'Miscellaneous'),
]
