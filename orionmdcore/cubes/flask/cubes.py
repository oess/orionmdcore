...
try:
    ...
    from floe.api import ParallelMixin, parameters, ComputeCube, SourceCube
...
class MDAPIDatasetConverterCube(RecordPortsMixin, ComputeCube):
    ...
    tags = ['Simulation', 'Complex', 'Protein', 'Ligand']
    description = """
    This cube converts MD Datasets generated by
    using the MD API presents int the OpenMM-Orion
    packages with versions <=4.0.2
    """

    uuid = "0ecced53-811b-4da4-8e20-ca64a5af24df"
